...
def basecall_method_checker(folder_path, input_folder, df):
    ...
    for file_name in input_folder:
        ...
        #print(cluster_name_search[0])
        #print(tax_name_search[0])
        #print(df.at[tax_name_search[0], cluster_name_search[0]])
...
def main():
    ...
    #df_produce = make_df(rapup_results, rapup_blast_results)
    #print(df_produce)
